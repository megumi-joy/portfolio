                    ...
                    <div className="p-6 md:p-10 grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="md:col-span-2 space-y-8">
                            ...
                            {game.media && game.media.length > 0 && (
                                <section>
                                    <h3 className="text-lg font-bold text-slate-300 mb-3">Screenshots</h3>
                                    <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                                        {game.media.map((src, i) => (
                                            <img
                                                key={i}
                                                src={src}
                                                alt={`${game.title} screenshot ${i + 1}`}
                                                className="rounded-lg object-cover w-full aspect-video hover:scale-105 transition-transform duration-200 cursor-pointer border border-slate-700/50"
                                            />
                                        ))}
                                    </div>
                                </section>
