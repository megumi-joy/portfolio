                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <Link to="/sobre" className="text-sm text-slate-600 dark:text-slate-300 hover:text-[rgb(var(--accent-rgb,6,182,212))] transition-colors">
                                {language === 'en' ? 'About' : language === 'ru' ? 'О нас' : language === 'uk' ? 'Про нас' : 'Sobre'}
                            </Link>
                        </div>
                    </div>
